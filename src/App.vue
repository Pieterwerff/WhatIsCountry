<template>
  ...
  <div v-if="newInstance == true">
    ...
    <p>
      ...
      find all sorts of information about a country of interest!
    </p>
    <p>
  ...
  methods: {
    ...
    fetchCountryWeather(weatherRequest) {
      ...
      let options = {
        ...
        params: { q: weatherRequest },
        headers: {
          "X-RapidAPI-Key":
            "f63af4fb4bmsh88069a0b1a57525p17dfa2jsn9c74e840185b",
